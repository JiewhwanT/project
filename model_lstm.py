...
# load model
model = load_model('./model/weight/model_lstm.h5')
# load tokenizer
tokenizer_path = './model/weight/tokenizer_lstm.pkl'
...
def convert_text(text):
    ...
    text = pad_sequences(text, maxlen=1193, padding='post', truncating='post')
    return text

def predict_lstm(inputText1, decode=False):
